...
<div class="header-container">
    <div class="header-title">🔮 Single Day Prediction</div>
    <div class="header-subtitle">Predict rain for a specific location and day</div>
</div>
...
with st.form("prediction_form"):
    st.markdown('<div class="section-header">📍 Location & Date</div>', unsafe_allow_html=True)
    ...
    st.markdown('<div class="section-header">🌡️ Temperature</div>', unsafe_allow_html=True)
    ...
    st.markdown('<div class="section-header">💧 Humidity & Rainfall</div>', unsafe_allow_html=True)
    c1, c2, c3 = st.columns(3)
    ...
    st.markdown('<div class="section-header">💨 Wind</div>', unsafe_allow_html=True)
    c1, c2, c3 = st.columns(3)
    ...
    st.markdown('<div class="section-header">🌤️ Other</div>', unsafe_allow_html=True)
    c1, c2, c3, c4 = st.columns(4)
